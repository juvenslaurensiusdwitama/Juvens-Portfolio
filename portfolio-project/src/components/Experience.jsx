const Experience = ({ data }) => {
	const { image, company, position, type, startDate, endDate, descriptions, delay, animate } = data
	return (
		<div data-aos={animate} data-aos-duration={800} data-aos-delay={data.delay} className="w-full rounded-[14px] border border-white/10 border-l-2 border-l-white/25 bg-white/[0.04] px-6 py-5.5 transition duration-300 hover:border-l-white/35 hover:border-white/15 hover:bg-white/[0.08]">
