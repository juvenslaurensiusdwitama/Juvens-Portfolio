...
const Experiences = () => {
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col lg:gap-5 md:gap-4 sm:gap-3 justify-center items-center w-full xl:max-w-[1300px] xl:px-[50px] lg:max-w-[910px] md:max-w-[700px] sm:max-w-[580px]'>
        {datas.map((data, i) => (
