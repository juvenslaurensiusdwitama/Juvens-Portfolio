...
const Experiences = () => {
  ...
  return (
    <div
      className='relative flex flex-col items-center xl:gap-10 lg:gap-8 sm:gap-9 text-white pt-25'
      id='experiences'
    >
      <h1 className='xl:text-3xl lg:text-2xl sm:text-xl font-semibold'>My Experiences</h1>
      <div className='flex flex-col xl:gap-5 md:gap-4.5 sm:gap-4 justify-center items-center w-full xl:max-w-[1300px] xl:px-[50px] lg:max-w-[910px] md:max-w-[700px] sm:max-w-[580px]'>
        {datas.map((data, i) => (
