    ...
    <>
      <div className="flex justify-center fixed left-0 right-0 top-0 z-50">
        <div className='flex text-white justify-between items-center w-full xl:max-w-[1300px] xl:px-[50px] lg:max-w-[910px] md:max-w-[700px] sm:max-w-[580px] lg:mt-7 sm:mt-9'>
          <h1 className='xl:text-2xl md:text-xl sm:text-lg font-[600] cursor-pointer' onClick={() => scrollToSection('introduction')}>Juvens.dev</h1>
          <div className='flex text-white'>
            <ul className='flex lg:gap-0 md:gap-4 sm:gap-3 xl:text-lg md:text-base sm:text-sm font-[500] lg:bg-white/20 lg:backdrop-blur-md lg:rounded-4xl'>
