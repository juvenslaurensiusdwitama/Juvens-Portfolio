  ...
  return (
    <>
      <div className="flex justify-center fixed left-0 right-0 top-0 z-50">
        <div className='flex text-white justify-between items-center w-full xl:max-w-[1300px] xl:px-[50px] lg:max-w-[910px] md:max-w-[700px] mt-7'>
          <h1 className='lg:text-2xl md:text-xl font-[600] cursor-pointer' onClick={() => scrollToSection('introduction')}>Juvens.dev</h1>
          <div className='flex text-white'>
            <ul className='flex lg:gap-0 md:gap-3 xl:text-lg lg:text-base font-[500] lg:bg-white/20 lg:backdrop-blur-md lg:rounded-4xl'>
