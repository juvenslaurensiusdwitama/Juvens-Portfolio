  ...
  return (
    <>
      ...
      <div className="flex justify-center fixed left-0 right-0 top-0 z-50">
        <div className='flex text-white justify-between items-center w-full max-w-[1200px] mt-10'>
      ...
      <div className="flex justify-center fixed left-0 right-0 bottom-0 z-50">
        <div className='flex text-white justify-center w-full max-w-[1200px] mb-10'>
