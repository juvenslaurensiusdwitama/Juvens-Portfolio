...
const Projects = () => {
  return (
    ...
    >
      ...
      <div className='w-full xl:max-w-[1300px] xl:px-[50px] lg:max-w-[910px] md:max-w-[700px] sm:max-w-[580px] sm:px-0 px-3 grid grid-cols-1 lg:grid-cols-2 sm:gap-0 gap-4'>
